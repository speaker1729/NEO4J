        ...
        if (matches) {
          switch (keyword) {
            ...
            case "城市":
              ...
              break;
            case "地点":
              this.columns.find((column) => column.name === 'Place').isVisible = true;
              break;
            case "类型":
            ...
            case "天气":
              ...
              break;
            case "原因":
              this.columns.find((column) => column.name === 'Cause').isVisible = true;
              break;
            case "时间":
    ...
    getDataAndDraw() {
      ...
      node.append("circle")
          ...
          .attr("fill", d => {
            ...
            switch (d.label) {
              case 'Province':
                return d.properties.name ? d.properties.switchActiveColor : '#3ca8cc';
              case 'City':
                return d.properties.name ? d.properties.switchActiveColor : '#c9b051';
              case 'Area':
                return d.properties.name ? d.properties.switchActiveColor : '#49a964';
              case 'Place':
                return d.properties.name ? d.properties.switchActiveColor : '#fc7349';
              case 'POI':
                return d.properties.name ? d.properties.switchActiveColor : '#7fad7b';
              case 'Time':
                return d.properties.name ? d.properties.switchActiveColor : '#6f95d0';
              case 'Weather':
                return d.properties.name ? d.properties.switchActiveColor : '#e8a75a';
              case 'Person':
                return d.properties.name ? d.properties.switchActiveColor : '#c280c2';
              case 'TripMode':
                return d.properties.name ? d.properties.switchActiveColor : '#be7843';
              case 'Cause':
                return d.properties.name ? d.properties.switchActiveColor : '#8377b6';
              default:
                return '#ccc';
            }
          })
